          ...
          <div className="grid md:grid-cols-3 gap-8 text-left mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><button onClick={() => scrollToSection('framework')} className="hover:text-blue-400 transition-colors">Framework</button></li>
                <li><button onClick={() => scrollToSection('services')} className="hover:text-blue-400 transition-colors">Services</button></li>
                <li><button onClick={() => scrollToSection('strategy-call')} className="hover:text-blue-400 transition-colors">Strategy Call</button></li>
              </ul>
            </div>
            <div>
